...
public:
    ...
    ~SetActivity()
		{
        speech_rec_proxy_ptr->unsubscribe("WordRecognized");
		}
	...
	int executeCB(ros::Duration dt)
		{
			...
			if (!init_)
			{
              ...
              //  activity_vocabulary.assign(2,"50");
                ...
                speech_rec_proxy_ptr->subscribe("WordRecognized");

			}


            al_word_vector = memory_proxy_ptr->getData("WordRecognized");
            word_recognized =  memory_proxy_ptr->getData("WordRecognized");
