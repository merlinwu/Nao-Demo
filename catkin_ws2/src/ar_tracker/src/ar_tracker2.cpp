...
const char     *patt_name[NMARKERS]   = {"data/multi/patt.letter_a2", "data/multi/patt.letter_b2", "data/multi/patt.letter_c2",
                                         "data/multi/patt.letter_d2", "data/multi/patt.letter_f2", "data/multi/patt.letter_g2"};
...
int main(int argc, char **argv)
{
	...
	tracker_pub = n.advertise<std_msgs::String>("marker_tracker2", 1000);
	arMarkerPub = n.advertise<ar_tracker::ARMarker>("ar_pose_marker2", 0);
	if (publishVisualMarkers)
		rvizMarkerPub = n.advertise<visualization_msgs::Marker>("visualization_marker2", 0);
