...
const char     *patt_name[NMARKERS]   = {"data/multi/patt.letter_a1", "data/multi/patt.letter_b1", "data/multi/patt.letter_c1",
                                         "data/multi/patt.letter_d1", "data/multi/patt.letter_f1", "data/multi/patt.letter_g1"};
...
int main(int argc, char **argv)
{
	...
	tracker_pub = n.advertise<std_msgs::String>("marker_tracker1", 1000);
	arMarkerPub = n.advertise<ar_tracker::ARMarker>("ar_pose_marker1", 0);
	if (publishVisualMarkers)
		rvizMarkerPub = n.advertise<visualization_msgs::Marker>("visualization_marker1", 0);
